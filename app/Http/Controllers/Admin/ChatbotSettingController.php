...
class ChatbotSettingController extends Controller
{
    public function index()
    {
        $setting = ChatbotSetting::firstOrCreate(['id' => 1], [
            ...
            'greeting_message' => "Halo! Saya adalah **Asisten Puskesmas**, asisten virtual resmi Puskesmas **Puskesmas Marunggi**. Saya siap membantu Anda mendapatkan informasi seputar layanan Puskesmas **Puskesmas Marunggi**. Sebagai AI Assistant yang dikembangkan membantu masyarakat mencari informasi resmi seputar Puskesmas **Puskesmas Marunggi**. Saya bukan manusia dan bukan tenaga medis, sehingga tidak dapat melakukan diagnosis penyakit atau memberikan resep obat.\n\nAda yang bisa saya bantu terkait layanan Puskesmas **Puskesmas Marunggi**?",
