...
<main class="pt-28 pb-20 px-4 sm:px-6 lg:px-10 max-w-7xl mx-auto">
            ...
            <div class="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
                ...
                <div class="max-w-3xl">
                    ...
                    <p class="text-white/90 text-base md:text-lg leading-relaxed max-w-2xl">
                        ...
                        Kumpulan dokumen, laporan, dan file inovasi III
    ...
    <img src="{{ $url }}" alt="Preview Gambar" class="w-full h-full object-cover rounded-2xl">
                ...
                <p class="text-sm text-slate-500 leading-relaxed line-clamp-3">
                    ...
                    {{ $d->keterangan ?? 'Dokumen inovasi Pokja III tersimpan secara digital.' }}
        ...
        <div class="col-span-full">
            ...
            <div class="rounded-3xl border border-dashed border-slate-300 bg-slate-50 py-20 text-center">
                ...
                <p class="text-slate-500 max-w-md mx-auto">
                    ...
                    Data dokumen inovasi Pokja III belum tersedia
