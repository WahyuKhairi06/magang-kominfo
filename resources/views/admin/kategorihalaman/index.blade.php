...
<div class="p-6"> <!-- 🔥 kasih jarak dari tepi layar -->
  ...
  <div class="bg-white rounded-3xl shadow-lg border border-slate-200 overflow-hidden">
    ...
    <div class="p-6 flex items-center justify-between border-b border-slate-100">
      <h3 class="font-bold text-slate-800">Data Kategori Profil</h3>
          ...
          <tr class="hover:bg-slate-50 transition">
            ...
            <td class="px-6 py-4 text-center">
              <button 
                ...
                onclick="openModal('modal-edit{{ $halaman->id }}')">
    ...
    <span class="material-symbols-outlined">delete</span>
          ...
          @include('admin.kategorihalaman.edit')
          @include('admin.kategorihalaman.hapus')
          @endforeach
        </tbody>
      </table>
    </div>
    ...
    <div class="p-4 bg-slate-50 flex items-center justify-between border-t">
      <p class="text-sm text-slate-500">
        {{-- Total: <span class="font-bold text-slate-800">{{ count($halamans) }}</span> --}}
      </p>
...
@include('admin.kategorihalaman.tambah')
