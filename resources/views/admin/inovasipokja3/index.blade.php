{{-- resources/views/admin/inovasipokja3/index.blade.php --}}
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        ...
        <div>
            ...
            <h1 class="text-2xl font-bold text-gray-800">
                Data Inovasi Pokja III
            </h1>

            <p class="text-gray-500 mt-1">
                Daftar dokumen dan file inovasi pokja.
            </p>
        ...
        <div>
            ...
            <a href="{{ route('inovasipokja3.create') }}"
                    ...
                    <tr class="border-b hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-4">
                            ...
                            <div class="flex items-center justify-center gap-2">
                                ...
                                {{-- EDIT --}}
                                <a href="{{ route('inovasipokja3.edit',$d->id) }}"
                                ...
                                {{-- DELETE --}}
                                <form id="delete{{ $d->id }}"
                                      action="{{ route('inovasipokja3.delete',$d->id) }}"
                                      method="POST">
