...
<div class="p-6">
  ...
  <div class="max-w-4xl mx-auto bg-white rounded-3xl shadow-lg border border-slate-200 overflow-hidden">
    ...
    <div class="p-6 border-b flex items-center justify-between">
      <h3 class="font-bold text-slate-800 text-lg">Edit Agenda</h3>
    ...
    <!-- FORM -->
    <form action="{{ route('agenda.update', $data->id) }}" method="POST" class="p-6 space-y-6">
      @csrf
      @method('PUT')
      ...
      <div>
        ...
        <input type="text" name="judul_agenda" value="{{ old('judul_agenda', $data->judul_agenda) }}"
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input type="time" name="jam_selesai" value="{{ old('jam_selesai', $data->jam_selesai) }}"
            class="w-full rounded-xl border border-slate-300 px-4 py-2 focus:ring-2 focus:ring-primary focus:outline-none">
        </div>
      </div>
      ...
      <div>
        ...
        <input type="text" name="penyelenggara" value="{{ old('penyelenggara', $data->penyelenggara) }}"
          class="w-full rounded-xl border border-slate-300 px-4 py-2 focus:ring-2 focus:ring-primary focus:outline-none">
      </div>
