...
<div class="p-6">
  ...
  <div class="max-w-5xl mx-auto bg-white rounded-3xl shadow-lg border border-slate-200 overflow-hidden">
    ...
    <div class="p-6 border-b flex items-center justify-between">
      <h3 class="font-bold text-slate-800 text-lg">Tambah Halaman Pokja</h3>
    ...
    <!-- FORM -->
    <form action="{{ route('halamanpokja.store') }}" method="POST" class="p-6 space-y-6">
      @csrf
      ...
      <div>
        ...
        <input type="text" name="judul" value="{{ old('judul') }}"
          ...
          placeholder="Contoh: Program Kerja Pokja I">
