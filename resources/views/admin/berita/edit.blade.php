<div class="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-md modal-overlay" id="modal-edit{{ $berita->id }}">
  <div class="bg-white w-full max-w-2xl rounded-[32px] shadow-2xl overflow-hidden modal-content">
    ...
    <form class="p-8 space-y-6"
      action="{{ route('kategori-berita.update', $berita->id) }}"
      method="POST">
      @csrf
      @method('PUT')
