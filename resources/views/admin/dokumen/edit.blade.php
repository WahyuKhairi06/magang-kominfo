...
<div class="p-6">
  ...
  <div class="max-w-4xl mx-auto bg-white rounded-3xl shadow-lg border border-slate-200 overflow-hidden">
    ...
    <div class="p-6 border-b flex items-center justify-between">
      <h3 class="font-bold text-slate-800 text-lg">Edit Dokumen</h3>
    ...
    <!-- FORM -->
    <form action="{{ route('dokumen.update', $data->id) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
      @csrf
      @method('PUT')
