...
<head>
    ...
    <title>Lupa Password - Puskesmas Marunggi</title>
    ...
    <main class="flex-grow flex items-center justify-center px-6 py-16">
        ...
        <div class="w-full max-w-md">
            ...
            <div class="login-card">
                ...
                <!-- Session Status -->
                @if(session('status'))
                    <div class="bg-primary/10 text-primary rounded-lg p-3 text-sm mb-5 text-center font-medium">
                        {{ session('status') }}
                    </div>
                @endif
                ...
                <form method="POST" action="{{ route('password.email') }}" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between text-sm mt-2">
                        <a href="{{ route('login') }}" class="text-primary hover:underline font-semibold flex items-center gap-1">
