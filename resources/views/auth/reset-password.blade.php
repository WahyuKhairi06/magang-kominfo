...
<head>
    ...
    <title>Reset Password - Puskesmas Marunggi</title>
                ...
                <form method="POST" action="{{ route('password.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="input-group mt-2">
                            ...
                            <input type="email" name="email" value="{{ old('email', $request->email) }}" required autofocus autocomplete="username" class="form-input bg-gray-100" readonly>
                        </div>
                        @error('email')
                    ...
                    <div>
                        ...
                        <div class="input-group mt-2">
                            ...
                            <input type="password" name="password" required autocomplete="new-password" class="form-input" placeholder="Buat password baru">
                        </div>
                        @error('password')
                            <p class="text-error text-sm mt-2">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="input-group mt-2">
                            ...
                            <input type="password" name="password_confirmation" required autocomplete="new-password" class="form-input" placeholder="Ulangi password baru">
                        </div>
