            ...
            <div class="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
                ...
                <div class="max-w-3xl">
                    ...
                    <p class="text-white/90 text-base md:text-lg leading-relaxed max-w-2xl">
                        ...
                        Kumpulan dokumen, laporan, dan file inovasi Sekretariat
                ...
                <div class="mb-6">
                    ...
                    @if($file)
                        ...
                        @elseif(in_array($ext,['jpg','jpeg','png']))
                          <a href="{{ $url }}" target="_blank"> <div class="w-20 h-20 rounded-2xl bg-purple-100 flex items-center justify-center shadow-inner overflow-hidden">
    <img src="{{ $url }}" alt="Preview Gambar" class="w-full h-full object-cover rounded-2xl">
</div></a>
                        @else
                            {{-- File bukan gambar atau dokumen dikenal, tampilkan ikon dokumen --}}
                ...
                <p class="text-sm text-slate-500 leading-relaxed line-clamp-3">
                    {{ $d->keterangan ?? 'Dokumen inovasi Sekretariat tersimpan secara digital.' }}
                </p>
            ...
            <div class="px-6 py-5 border-t border-slate-100 bg-slate-50/70 backdrop-blur-sm">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-slate-200 text-xs font-semibold text-slate-700 shadow-sm">
                        ...
                        {{ $ext ? strtoupper($ext) : 'N/A' }}
                    </div>

                    {{-- BUTTON --}}
                    @if($file)
                        <a href="{{ $url }}" target="_blank" class="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-4 py-2.5 rounded-xl text-sm font-semibold shadow-lg hover:scale-105 hover:shadow-xl transition-all duration-300">
                            <span class="material-symbols-outlined text-[18px]">open_in_new</span>
                            Buka
                        </a>
                    @else
                        <span class="text-sm text-slate-400">Tidak ada file</span>
                    @endif
        ...
        <div class="col-span-full">
            ...
            <div class="rounded-3xl border border-dashed border-slate-300 bg-slate-50 py-20 text-center">
                ...
                <p class="text-slate-500 max-w-md mx-auto">
                    Data dokumen inovasi Sekretariat belum tersedia
