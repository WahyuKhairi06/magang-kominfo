...
return new class extends Migration
{
     ...
     * Jalankan migration.
     *
     * PENTING: Sesuaikan nama tabel di bawah ini kalau tabel pengaduan di project
     * asli namanya bukan persis "pengaduans" (cek dulu dengan `php artisan tinker`
     * atau lihat migration lama sebelum menjalankan ini).
     */
    public function up(): void
    {
        Schema::table('pengaduans', function (Blueprint $table) {
            // Hasil mentah dari AI — TIDAK BERUBAH walau admin override (jejak audit)
            $table->string('kategori_ai', 100)->nullable()->after('isi');
